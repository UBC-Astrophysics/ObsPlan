...
\begin{abstract}
The initial source localizations from LIGO-Virgo have covered large
...
would appear are varied and uncertain. In particular because the first
discovered gravitational wave events appear to be the merger of binary
black holes, the appearance and duration of the electromagnetic
counterparts are especially uncertain, and rapid electromagnetic
follow-up of a large portion of the probable region would increase the
chance of success in finding a counterpart.  Over the large search
regions and over the span of days or weeks, many electromagnetic
transients typically occur, and with the wide variety of models it
will be difficult to associate unambigously a particular
electromagnetic event with a candidate gravitational-wave event.
