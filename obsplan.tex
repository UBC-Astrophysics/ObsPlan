...
gravitational-wave events, we will focused on the rapid Bayesian
...
the form of a HEALPix map \citep{2005ApJ...622..759G} where each
...
indicates that focusing the search on massive galaxies might not be
...
informed by one's prior knowledge of the source inspired by
